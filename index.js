...
if(weather === "sunny"){
document.writeln(` <div class="d-flex align-items-center justify-content-center" style="height: 100vh;width: 100vw;overflow: hidden;background-color: cornsilk ;"><div class="card  d-flex  " style="width: 18rem;align-items-center; justify-content: center;">
...
We feel warm and happy.</p>
    ...
    document.writeln(` <div class="d-flex align-items-center justify-content-center" style="height: 100vh;width: 100vw;overflow: hidden; background-color: rgb(96, 185, 210);">
...
We use umbrellas and raincoats.</p>
  ...
  document.writeln(` <div class="d-flex align-items-center justify-content-center" style="height: 100vh;width: 100vw;overflow: hidden;background-color: darkgray;">
<div class="card" style="width: 18rem;">
...
It may rain anytime.</p>
  ...
  document.writeln(`  <div class="d-flex align-items-center justify-content-center" style="height: 100vh;width: 100vw;overflow: hidden;background-color: rgb(161, 148, 97)">
<div class="card" style="width: 18rem;">
...
Kites fly high in the sky.</p>
  ...
  document.writeln(`  <div class="d-flex align-items-center justify-content-center" style="height: 100vh;width: 100vw;overflow: hidden;background-color: rgb(206, 195, 150)">
<div class="card" style="width: 18rem;">
...
Sometimes there is fog or snow.</p>
  ...
  document.writeln(` <div class="d-flex align-items-center justify-content-center" style="height: 100vh;width: 100vw;overflow: hidden;background-color: rgb(208, 235, 165)">
<div class="card" style="width: 18rem;">
...
We drink water and wear light clothes.</p>
  ...
  document.writeln(` <div class="d-flex align-items-center justify-content-center" style="height: 100vh;width: 100vw;overflow: hidden;background-color: rgb(100, 116, 99);">
<div class="card" style="width: 18rem;">
...
We stay safe indoors.</p>
  ...
  document.writeln(` <div class="d-flex align-items-center justify-content-center" style="height: 100vh;width: 100vw;overflow: hidden;background-color: rgb(160, 150, 194);">
<div class="card" style="width: 18rem;">
...
Everything looks white and beautiful.</p>
  ...
  document.writeln(`<div class="d-flex align-items-center justify-content-center" style="height: 100vh;width: 100vw;overflow: hidden;background-color: rgba(228, 204, 109, 0.963)">
<div class="card" style="width: 18rem;">
...
Leaves change color and fall from trees.</p>
  ...
  document.writeln(`<div class="d-flex align-items-center justify-content-center" style="height: 100vh;width: 100vw;overflow: hidden;background-color: cornsilk">
<div class="card" style="width: 18rem;">
